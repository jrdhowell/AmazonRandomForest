...
load.libraries <- c('tidyverse', 'gridExtra', 'dplyr', 'lubridate', 'readxl', 'ggplot2', 'stringr', 'randomForest', 'fastDummies', 'janitor', 'caret', 'AUC', 'plotrix')
...
orders_data <- orders_data %>% 
  ...
  mutate(shipping_fee   = as.double(gsub(",", "",(substr(shipping_fee, 2, nchar(shipping_fee)-1))))) %>% 
  mutate(item_total =   as.double(gsub(",", "",(substr(item_total, 2, nchar(item_total)))))) %>%
